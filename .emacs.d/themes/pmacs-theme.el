...
;;; Commentary:
;;; pmacs theme created by Peter Hofmann in 2023
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; all other cursors will be same color if I don’t set them explicitly:
   `(ph/meow-calc-cursor ((,class (:background ,builtin))))
   ;; should inherit from cursor, which somehow is not defined:
   `(meow-beacon-cursor ((,class (:inherit ,font-lock-builtin-face))))
   `(meow-insert-cursor ((,class (:inherit ,font-lock-builtin-face))))
   `(meow-keypad-cursor ((,class (:inherit ,font-lock-builtin-face))))
   `(meow-kmacro-cursor ((,class (:inherit ,font-lock-builtin-face))))
   ...
   `(org-level-1 ((,class (:bold t :foreground ,level1))))
   `(org-level-2 ((,class (:bold t :foreground ,level2))))
   `(org-level-3 ((,class (:bold t :foreground ,level3))))
   `(org-level-4 ((,class (:bold t :foreground ,level4))))
   `(org-level-5 ((,class (:bold t :foreground ,level5))))
   `(org-level-6 ((,class (:foreground ,level1))))
   `(org-level-7 ((,class (:foreground ,level2))))
   `(org-level-8 ((,class (:foreground ,level3))))
   `(org-date ((,class (:underline t :foreground ,var) )))
   `(org-footnote  ((,class (:underline t :foreground ,fg4))))
   `(org-link ((,class (:underline t :foreground ,type ))))
   `(org-drawer ((,class (:bold t :foreground ,comment))))
   `(org-special-keyword ((,class (:foreground ,comment))))
   `(org-property-value ((,class (:italic t :foreground ,comment))))
   `(org-block ((,class (:foreground ,fg3 :background ,bg5))))
