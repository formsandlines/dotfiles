...
(defun ph/open-notes ()
  "Quickly opens my notes buffer or the file if the buffer doesn’t exist."
  (interactive)
  (let ((buff (get-buffer "emacs-notes.org")))
    (if buff
	(switch-to-buffer buff)
      (find-file "~/Documents/emacs-notes.org"))))

(keymap-global-set "C-c n" #'ph/open-notes)
#+end_src
* GUI tweaks
#+begin_src elisp
...
**** flycheck
#+begin_src elisp
(defun ph/disable-checker-in-mode ()
  "Disable emacs-lisp-checkdoc checker in the emacs-lisp-mode."
...
(use-package flycheck
  ...
  (add-hook 'emacs-lisp-mode-hook 'ph/disable-checker-in-mode))
#+end_src
