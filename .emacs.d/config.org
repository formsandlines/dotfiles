...
(defun ph/visit-config ()
  "Opens my config.org file."
  (interactive)
  (find-file (locate-user-emacs-file "config.org")))

(keymap-global-set "C-c c" #'ph/visit-config)
...
(use-package org
  :config
  (keymap-set org-mode-map "C-M-<return>" #'ph/org-insert-child-heading)

  (keymap-set org-mode-map "C-c <return>" #'ph/meow-org-insert-heading)

  (keymap-set org-mode-map "C-c S-<return>" #'ph/meow-org-insert-child-heading)
  ;
