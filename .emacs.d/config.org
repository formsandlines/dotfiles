...
(defun ph/meow-symex-setup ()
  ...
  (meow-define-keys 'symex
    ...
    '("C--" . symex-clear)
    '("s" . ph/symex-replace) ;; same as change?
    ...
    '("o" . ph/symex-open-line-after)
    '("O" . ph/symex-open-line-before)
    ...
    '("a" . ph/symex-insert-at-end) ;; was symex-insert-at-end
    '("i" . meow-insert) ;; was symex-insert-at-beginning
